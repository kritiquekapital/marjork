...
// Modify draggable.js to register as bounceable
export class Draggable {
    ...
    applyPhysics() {
        const animate = () => {
            this.velocity.x *= this.friction;
            this.velocity.y *= this.friction;
            this.element.style.left = `${parseFloat(this.element.style.left) + this.velocity.x}px`;
            this.element.style.top = `${parseFloat(this.element.style.top) + this.velocity.y}px`;
            requestAnimationFrame(animate);
        };
        requestAnimationFrame(animate);
    }
