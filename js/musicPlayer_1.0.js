...
// Fix click outside close issue
overlay.addEventListener("click", () => {
  console.log("Overlay clicked, closing player...");
  hideMusicPlayer();
});

// Add missing close event listener for menu button
document.querySelector(".close-btn")?.addEventListener("click", hideMusicPlayer);
...
// Ensure player is draggable correctly
new Draggable(musicPlayer, ".drag-handle");
